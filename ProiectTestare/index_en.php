...
<div class="container">
    ...
    <form method="post" action="">
        ...
        <label for="currency_a">Exchange from:</label>
    ...
    <?php 
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") { 
            ...
            if (!is_numeric($amount)) {
                $error = "You must enter a number."; //Adauga mesaj de eroare daca suma nu este numar
            }
            else
            {
                //Afiseaza optiunile alese
                echo "You chose to exchange from $currency_a to $currency_b<br>";
                echo "Amount you want exchanged: $amount $currency_a<br>";

                //Cazul in care valuta este acceeasi
                if ($currency_a == $currency_b) {
                    echo "According to the BNR exchange rate from 19.11.2024, the exchanged amount in $currency_b is: $amount $currency_b";
                }
                ...
                if ($currency_a == 'RON' && $currency_b == 'EUR') {
                    ...
                    echo "According to the BNR exchange rate from 19.11.2024, the exchanged amount in $currency_b is: $converted_amount EUR";
                } elseif ($currency_a == 'EUR' && $currency_b == 'RON') {
                    $converted_amount = $amount * 4.98;  // Curs BNR din 19.11.2024
                    echo "According to the BNR exchange rate from 19.11.2024, the exchanged amount in $currency_b is: $converted_amount RON";
                }

                if ($currency_a == 'RON' && $currency_b == 'USD') {
                    $converted_amount = $amount * 0.21;  // Curs BNR din 19.11.2024
                    echo "According to the BNR exchange rate from 19.11.2024, the exchanged amount in $currency_b is: $converted_amount USD";
                ...
                if ($currency_a == 'RON' && $currency_b == 'CAD') {
                    ...
                    echo "According to the BNR exchange rate from 19.11.2024, the exchanged amount in $currency_b is: $converted_amount CAD";
                ...
                if ($currency_a == 'RON' && $currency_b == 'GBP') {
                    ...
                    echo "According to the BNR exchange rate from 19.11.2024, the exchanged amount in $currency_b is: $converted_amount GBP";
                ...
                if ($currency_a == 'RON' && $currency_b == 'HUF') {
                    ...
                    echo "According to the BNR exchange rate from 19.11.2024, the exchanged amount in $currency_b is: $converted_amount HUF";
