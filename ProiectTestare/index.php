...
<div class="container">
    ...
    <form method="post" action="">
        ...
        <label for="currency_a">Schimba din:</label>
    ...
    <?php 
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!is_numeric($amount)) {
                $error = "Trebuie introdus un număr."; //Adauga mesaj de eroare daca suma nu este numar
            }
            else
            {
                //Afiseaza optiunile alese
                echo "Ai ales să schimbi din $currency_a în $currency_b<br>";
                $formatted_amount = str_replace('.', ',', $amount);
                echo "Suma pe care o dorești a fi schimbată: $formatted_amount $currency_a<br>";

                //Cazul in care valuta este acceeasi
                if ($currency_a == $currency_b) {
                    echo "Conform cursului BNR din 19.11.2024, suma convertită în $currency_b este: $formatted_amount $currency_b";
                }
                ...
                if ($currency_a == 'RON' && $currency_b == 'EUR') {
                    ...
                    echo "Conform cursului BNR din 19.11.2024, suma convertită în $currency_b este: $converted_amount EUR";
                } elseif ($currency_a == 'EUR' && $currency_b == 'RON') {
                    $converted_amount = $amount * 4.98;  // Curs BNR din 19.11.2024
                    $converted_amount = str_replace('.', ',', $converted_amount);
                    echo "Conform cursului BNR din 19.11.2024, suma convertită în $currency_b este: $converted_amount RON";
                }

                if ($currency_a == 'RON' && $currency_b == 'USD') {
                    $converted_amount = $amount * 0.21;  // Curs BNR din 19.11.2024
                    $converted_amount = str_replace('.', ',', $converted_amount);
                    echo "Conform cursului BNR din 19.11.2024, suma convertită în $currency_b este: $converted_amount USD";
                ...
                if ($currency_a == 'RON' && $currency_b == 'CAD') {
                    ...
                    $converted_amount = str_replace('.', ',', $converted_amount);
                    echo "Conform cursului BNR din 19.11.2024, suma convertită în $currency_b este: $converted_amount CAD";
                ...
                if ($currency_a == 'RON' && $currency_b == 'GBP') {
                    ...
                    $converted_amount = str_replace('.', ',', $converted_amount);
                    echo "Conform cursului BNR din 19.11.2024, suma convertită în $currency_b este: $converted_amount GBP";
                ...
                if ($currency_a == 'RON' && $currency_b == 'HUF') {
                    ...
                    $converted_amount = str_replace('.', ',', $converted_amount);
                    echo "Conform cursului BNR din 19.11.2024, suma convertită în $currency_b este: $converted_amount HUF";
